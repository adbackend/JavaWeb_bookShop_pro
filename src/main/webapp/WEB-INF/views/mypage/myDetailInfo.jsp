...
<script type="text/javascript">
    ...
    function fn_modify_member_info(attribute){
    	...
    	if(attribute=='member_pw'){
    		...
    		var jibunAddess = frm_mod_member.jibunAddress;
    		var namujiAddress = frm_mod_member.namujiAddesss;
			...
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
						...
						<p>
						지번주소:<br>
						<input type="text" id="roadAddress" name="roadAddress" size="50" value="${memberInfo.roadAddress}"/><br><br>
						<input type="text" id="jibunAddress" name="jibunAddress" size="50" value="${memberInfo.jibunAddress}"/><br><br>
						<input type="text" id="namujiAddress" size="50" value="${memberInfo.namujiAddress}"/>
						</p>
					</td>
					<td>
	...
	<table align="center">
		<tr>
			<td>
				...
				<input type="button" name="btn_cancel_member" value="수정취소"/>
			</td>
		</tr>
	</table>
	</div>
