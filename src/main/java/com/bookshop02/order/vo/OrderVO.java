package com.bookshop02.order.vo;
...
public class OrderVO {
	...
	private int order_seq_num; //주문상품 일렬번호
	private String member_id; //주문자 아이디
	private int order_id; // 주문번호
	private int goods_id; //상품번호
	private String goods_title; // 상품이름
	private int goods_sales_price; // 상품 판매가격
	private int total_goods_price;
	
	private int cart_goods_qty; //장바구니에 담긴 제품수
	private int order_goods_qty; //최종 주문 제품수
	
	private String orderer_name; //주문자 이름
	private String receiver_name; //수령자 이름
	private String receiver_hp1; //수령자 휴대폰 번호1
	private String receiver_hp2;
	private String receiver_hp3;
	private String receiver_tel1; //수령자 유선 번호1
	private String receiver_tel2;
	private String receiver_tel3;
	
	private String delivery_address; //배송주소
	private String delivery_message; //부재시 전달 메세지
	private String delivery_method; //배송방법
	private String gift_wrapping; //상품포장여부
	private String pay_method; //결제방법
	private String card_com_name; //결제카드 회사이름
	private String card_pay_month; //할부개월수
